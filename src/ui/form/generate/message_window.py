...
class Ui_MessageWindow(object):
    def setupUi(self, MessageWindow):
        ...
        MessageWindow.resize(426, 329)
        MessageWindow.setMinimumSize(QSize(426, 329))
        ...
        self.gridLayout_2.addLayout(self.buttons_layout, 3, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.close_btn, 5, 0, 1, 2)
