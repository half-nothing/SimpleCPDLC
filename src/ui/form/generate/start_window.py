...
class Ui_Start(object):
    def setupUi(self, Start):
        ...
        self.gridLayout.addWidget(self.start, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.register_label, 8, 1, 1, 1)
